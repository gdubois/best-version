...
- Name: app-e2e.test.js >> Home Page Tests >> 3.0-E2E-043 [P2] Submission modal prevents duplicate submissions
- Location: test/e2e/app-e2e.test.js:823:3
  ...
  - generic [ref=e43]:
    ...
    - generic [ref=e45]:
      - generic [ref=e46] [cursor=pointer]:
        - heading "EarthBound" [level=3] [ref=e48]
        - img "EarthBound cover art" [ref=e50]
        - generic [ref=e53]: 🎮 Nintendo Switch Online (SNES), Game Boy Advance (Mother 1+2), Super Nintendo Entertainment System (SNES), Windows (PC Emulation)
      ...
      - generic [ref=e70] [cursor=pointer]:
        - heading "Persona 3" [level=3] [ref=e72]
        - img "Persona 3 cover art" [ref=e74]
        - generic [ref=e77]: 🎮 Windows (Steam), PlayStation 5, Xbox Series X/S
      - generic [ref=e78] [cursor=pointer]:
        - heading "The Witcher" [level=3] [ref=e80]
        - img "The Witcher cover art" [ref=e82]
        - generic [ref=e85]: 🎮 Windows (PC - GOG/Steam), PlayStation 3, Xbox 360
      - generic [ref=e86] [cursor=pointer]:
        - heading "Metal Gear Solid" [level=3] [ref=e88]
        - img "Metal Gear Solid cover art" [ref=e90]
        - generic [ref=e93]: 🎮 Windows (GOG.com), PlayStation 4 / PlayStation 5 / Xbox Series X/S / Nintendo Switch / Windows (Steam), PlayStation (Original), PlayStation 2 (Twin Snakes), PlayStation Classic
  - generic [ref=e94]:
...
> 839 |     await titleInput.fill('Duplicate Test');
  ...
  909 |     await page.goto(`${BASE_URL}/admin`);
  910 | 
  911 |     // When - Look for stats
  912 |     const statCards = page.locator('.stat-card');
  913 | 
  914 |     // Then - Should have stat cards
  915 |     const count = await statCards.count();
  916 |     expect(count >= 0).toBe(true);
  917 |   });
  918 | 
  919 |   test('3.0-E2E-048 [P2] Admin page shows submissions list', async ({ page }) => {
  920 |     // Given - Admin page is loaded
  921 |     await page.goto(`${BASE_URL}/admin`);
  922 | 
  923 |     // When - Look for submissions list
  924 |     const submissionsList = page.locator('.submissions-list');
  925 | 
  926 |     // Then - Submissions list should exist
  927 |     const count = await submissionsList.count();
  928 |     expect(count >= 0).toBe(true);
  929 |   });
  930 | 
  931 |   test('3.0-E2E-049 [P2] Admin login page exists', async ({ page }) => {
  932 |     // Given - Navigate to admin login
  933 |     await page.goto(`${BASE_URL}/admin/login`);
  934 | 
